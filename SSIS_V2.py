...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Student Information System", font=("Edwardian Script ITC", 70), fg="#0000A0")
        label.place(x=230,y=80)

        labela = tk.Label(self, text="MSU-IIT", font=("Rosewood Std Regular", 30),fg="#0000A0")
        labela.place(x=300,y=180)
        
        course = tk.Button(self, text="COURSES",font=("Nueva Std",25,"bold"),bd=0, width = 10, padx=5, pady=5, bg="#ADD8E6", fg="#0000A0", command=lambda: controller.show(Courses))
        course.place(x=530,y=220)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Nueva Std",25,"bold"),bd=0, width = 13, padx=5, pady=5, bg="#ADD8E6", fg="#0000A0", command=lambda: controller.show(Students))
        students.place(x=503,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Nueva Std",15,"bold"),bd=0, width = 10, padx=5, pady=5, bg="#0000A0", fg="#ADD8E6", command=iExit)
        students.place(x=570,y=380)
        students.config(cursor= "hand2")
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSES", font=("Prestige Elite Std", 60), fg="#0000A0")
        ...
        home = tk.Button(self, text="HOME",font=("Nueva Std",18),bd=0, width = 10, bg="#0000A0", fg="#ADD8E6", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        ...
        self.lblccode = Label(self, font=("Garamond", 12, "bold"), text="Course Code:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        ...
        self.lblcname = Label(self, font=("Garamond", 12,"bold"), text="Course Name:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        ...
        self.SearchBar = Entry(self, font=("Arial", 11), textvariable=SearchBar_Var, bd=0,bg="#ADD8E6",width=31)
        self.SearchBar.place(x=806,y=105)
        ...
        self.course_list.column("Course Code", width=250, anchor=W, stretch=False)
        self.course_list.column("Course Name", width=480, stretch=False)
        
        self.course_list.bind("<Double-1> ", OnDoubleclick)


        self.course_list.place(x=400,y=140)
        scrollbar.config(command=self.course_list.yview)
            
        ## Buttons

        self.adds = Button(self, text="ADD", font=('Tekton Pro', 11, ), height=1, width=10, bd=1, bg="#0000A0", fg="#ADD8E6",command=add_course)
        self.adds.place(x=180,y=250)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Tekton Pro', 11), height=1, width=10, bd=1, bg="#0000A0", fg="#ADD8E6", command=update_course) 
        self.update.place(x=280,y=250)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Tekton Pro', 11), height=1, width=10, bd=1, bg="#0000A0", fg="#ADD8E6", command=clear)
        self.clear.place(x=180,y=300)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Tekton Pro', 11), height=1, width=10, bd=1, bg="#0000A0", fg="#ADD8E6", command=delete_course)
        self.delete.place(x=280,y=300)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Tekton Pro', 11, 'bold'),bd=0, bg="#0000A0", fg="#ADD8E6", command=search_course)
        self.search.place(x=1060,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Tekton Pro', 11, 'bold'), height=1, width=11, bg="#0000A0", fg="#ADD8E6", command=display_course)
        self.display.place(x=400,y=105)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Prestige Elite Std", 50), fg="#0000A0")
        label.place(x=100,y=15)
        
        home = tk.Button(self, text="HOME",font=("Nueva Std",18),bd=0, width = 7, bg="#0000A0", fg="#ADD8E6",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.lblid = Label(self, font=("Modern No. 20", 12), text="ID Number:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        self.lblid.place(x=125,y=120)
        self.txtid = Entry(self, font=("Arial", 13), textvariable=Student_ID, width=33)
        self.txtid.place(x=125,y=150)

        self.lblname = Label(self, font=("Modern No. 20", 12), text="Name (Last, First, M.I.):", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        self.lblname.place(x=125,y=180)
        self.txtname = Entry(self, font=("Arial", 13), textvariable=Student_Name, width=33)
        self.txtname.place(x=125,y=210)
        
        self.lblc = Label(self, font=("Modern No. 20", 12), text="Course Code:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        self.lblc.place(x=125,y=240)
        ...
        self.txtyear.place(x=125,y=270)
        

        self.lblyear = Label(self, font=("Modern No. 20", 12), text="Year Level:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        ...
        self.txtyear.place(x=125,y=330)
        
        self.lblgender = Label(self, font=("Modern No. 20", 13), text="Gender:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        self.lblgender.place(x=125,y=360)
        self.txtgender = ttk.Combobox(self, value=["Male", "Female"], font=("Arial", 13), state="readonly", textvariable=Student_Gender, width=28)
        self.txtgender.place(x=125,y=390)
        ...
        self.add = Button(self, text="REGISTER", font=('Tekton Pro', 11), height=1, width=10, bd=1,  bg="#0000A0", fg="#ADD8E6", command=add_stud)
        self.add.place(x=470,y=160)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Tekton Pro', 11), height=1, width=10, bd=1, bg="#0000A0", fg="#ADD8E6", command=update_stud)
        self.update.place(x=470,y=210)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Tekton Pro', 11), height=1, width=10, bd=1, bg="#0000A0", fg="#ADD8E6", command=clear)
        self.clear.place(x=470,y=260)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Tekton Pro', 11), height=1, width=10, bd=1, bg="#0000A0", fg="#ADD8E6", command=delete_stud)
        self.delete.place(x=470,y=310)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Tekton Pro', 11, 'bold'),bd=0, bg="#0000A0", fg="#ADD8E6", command=search_stud)
        self.search.place(x=1135,y=105)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Tekton Pro', 11, 'bold'), height=1, width=11,  bg="#0000A0", fg="#ADD8E6",command = display_stud)
