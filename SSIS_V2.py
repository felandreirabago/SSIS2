...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT Student Information System", font=("Pristina", 50), fg="#0000A0")
        label.place(x=170,y=20)
        
        course = tk.Button(self, text="COURSES",font=("Nueva Std",25,"bold"),bd=0, width = 10, bg="#0000A0", fg="#ADD8E6", command=lambda: controller.show(Courses))
        course.place(x=530,y=200)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Nueva Std",25,"bold"),bd=0, width = 13, bg="#0000A0", fg="#ADD8E6", command=lambda: controller.show(Students))
        students.place(x=503,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Nueva Std",15,"bold"),bd=0, width = 10, bg="#ADD8E6", fg="#0000A0", command=iExit)
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="HOME",font=("Nueva Std",13,"bold"),bd=0, width = 10, bg="#0000A0", fg="#ADD8E6", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="HOME",font=("Nueva Std",12,"bold"),bd=0, width = 7, bg="#0000A0", fg="#ADD8E6",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.lblid = Label(self, font=("Arial", 12,"bold"), text="ID Number:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        ...
        self.lblname = Label(self, font=("Arial", 12,"bold"), text="Name (Last, First, M.I.):", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        ...
        self.lblc = Label(self, font=("Arial", 12,"bold"), text="Course Code:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        ...
        self.lblyear = Label(self, font=("Arial", 12,"bold"), text="Year Level:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
        ...
        self.lblgender = Label(self, font=("Arial", 13,"bold"), text="Gender:", padx=5, pady=5, bg="#ADD8E6", fg="#0000A0")
